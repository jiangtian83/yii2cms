...
<body class="noselect">
    ...
    <header class="jt-col-md-12 jt-background-grad jt-height-80 jt-lineheight-100 jt-position-relative jt-margin-padding-0">
        ...
        <div class="jt-position-absolute jt-col-md-12 jt-margin-padding-0 jt-text-align-center jt-color-white jt-font-size-24 jt-lineheight-80" style="<?= $this->context->titleUp ? 'z-index: 9999;' : ''?>">
            <?= $this->context->title ?>
        </div>
    </header>

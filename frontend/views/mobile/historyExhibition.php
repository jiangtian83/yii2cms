...
<div class="layui-container">
    <div class="jt-column-title jt-col-md-12 jt-height-40 jt-margin-bottom-0 jt-lineheight-40 jt-font-color-gray jt-margin-top-10">
        <span class="jt-padding-15">第八期展会预告</span>
    </div>
    <div class="layui-row">
        <form class="layui-form">
            <div class="layui-form-item jt-margin-bottom-0">
                ...
                <div class="layui-input-block jt-input-block-4">
                    <input type="text" name="nickname" required  lay-verify="required" placeholder="xxxxxx" autocomplete="off" class="layui-input jt-login-input-no-border" readonly>
                </div>
            </div>
            <div class="layui-form-item jt-margin-bottom-0">
                <label class="layui-form-label jt-form-lable-3">展会时间：</label>
                <div class="layui-input-block jt-input-block-4">
                    <input type="text" name="account" required  lay-verify="required" placeholder="xxxxxx" autocomplete="off" class="layui-input jt-login-input-no-border" readonly>
                </div>
            </div>
            <div class="layui-form-item jt-margin-bottom-0">
            ...
            <div class="layui-form-item jt-margin-bottom-0">
                ...
                <div class="layui-input-block jt-input-block-4">
                    <input type="text" name="account" required  lay-verify="required" placeholder="" autocomplete="off" class="layui-input jt-login-input-no-border">
                </div>
            </div>
            <div class="layui-container">
                <div class="layui-form-item jt-margin-bottom-10">
                    ...
                    <div class="layui-input-block jt-input-block-4">
                        <input type="text" name="account" required  lay-verify="required" placeholder="xxxxxx" autocomplete="off" class="layui-input jt-login-input-no-border jt-background-lightgray jt-radius-5">
            ...
            <div class="layui-form-item jt-margin-top-30">
                <div class="jt-input-block-2 jt-text-align-center">
                    <button class="layui-btn jt-background-blue jt-col-md-12 jt-radius-5" lay-submit lay-filter="login">提交</button>
                </div>
            </div>
        </form>
    </div>
...
<div class="layui-container">
    <div class="jt-column-title jt-col-md-12 jt-height-40 jt-margin-bottom-0 jt-lineheight-40 jt-font-color-gray jt-margin-top-10">
        <span class="jt-padding-15">第七期展会</span>
    </div>
    <div class="layui-row">
        <form class="layui-form">
            <div class="layui-form-item jt-margin-bottom-0">
